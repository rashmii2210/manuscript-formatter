...
% to keep the present file readable, most
% packages & commands have been relocated
% to the constructions document class:
\documentclass[]{constructions}
...
\begin{figure}[H]
    ...
    \caption[Alt text for screen readers: Add alt text here.]{A sample figure}
...
\begin{figure}[H]
    ...
    \caption[Alt text for screen readers: Add alt text here.]{Another sample figure}
